...
swup.on('animationInDone', function () {
  ...
  const applicationServerKey =
    'BEcxUNEtDr8Tbz6ahGB3rYMqRs41s9fwkkkijEmc3JgRAcjODL_rEWHtiw0hLJOKG_HRozlTiuXao_uF3hNX_2c';
  ...
  function changePushButtonState(state) {
    switch (state) {
      case 'enabled':
        ...
        pushButton.textContent = 'Disabilita notifiche';
        isPushEnabled = true;
        break;
      case 'disabled':
        pushButton.disabled = false;
        pushButton.textContent = 'Abilita notifiche';
        isPushEnabled = false;
        break;
      case 'computing':
  ...
  sendPushButton.addEventListener('click', () =>
    navigator.serviceWorker.ready
      ...
      .then(subscription => {
        ...
        fetch('/pwa/notifications/send_notification.php', {
          method: 'POST',
